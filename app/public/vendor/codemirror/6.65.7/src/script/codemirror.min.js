!(function (e, t) {
	...
	var fe = 50,
		...
		ge = {
			scroll: !(de.prototype.set = function (e, t) {
				...
				t = +new Date() + e;
				(!this.id || t < this.time) &&
					(clearTimeout(this.id), (this.id = setTimeout(this.handler, e)), (this.time = t));
			}),
		},
		me = { origin: '*mouse' },
		ve = { origin: '+move' };
		...
		Re = function (e, t) {
			...
			for (var m = 0; m < i; ++m) {
				...
				if (',' == v) o[m] = 'N';
					...
					for (
						var b = (m && '!' == o[m - 1]) || (y < i && '1' == o[y]) ? '1' : 'N', w = m;
						w < y;
						++w
					)
						o[w] = b;
	...
	function At(n, r, e) {
		...
		var o = (function (e, t, n) {
				for (
					var r, i, o = e.doc, l = n ? -1 : t - (e.doc.mode.innerMode ? 1e3 : 100), s = t;
					l < s;
					--s
				) {
		...
		return (
			t.iter(o, r, function (e) {
				...
				var t = s.line;
				((e.stateAfter =
					t == r - 1 || t % 5 == 0 || (t >= i.viewFrom && t < i.viewTo) ? s.save() : null),
					s.nextLine());
			}),
	...
	function Pt(e, t, n, r) {
		...
		for (r && (o = []); (r || c.pos < t.ch) && !c.eol(); )
			((c.start = c.pos), (i = Ht(s, c, u.state)), r && o.push(new Ft(c, i, ht(l.mode, u.state))));
				...
				if (e)
					for (var i = 0; i < e.length; ++i) {
						...
						(!(null == l.from || (s.inclusiveLeft ? l.from <= t : l.from < t)) &&
							(l.from != t || 'bookmark' != s.type || (n && l.marker.insertLeft))) ||
				...
				if (e)
					for (var i = 0; i < e.length; ++i) {
						...
						(!(null == l.to || (s.inclusiveRight ? l.to >= t : l.to > t)) &&
							(l.from != t || 'bookmark' != s.type || (n && !l.marker.insertLeft))) ||
							((o = null == l.from || (s.inclusiveLeft ? l.from <= t : l.from < t)),
							(r = r || []).push(new Bt(s, o ? null : l.from - t, null == l.to ? null : l.to - t)));
					}
				return r;
			})(e, i, o),
			a = 1 == t.text.length,
		...
		if (l)
			for (var c = 0; c < l.length; ++c) {
				var h,
					d = l[c];
				null == d.to &&
					((h = Gt(s, d.marker)) ? a && (d.to = null == h.to ? null : h.to + u) : (d.to = r));
			}
		if (s)
			...
			for (var l = 0; l < o.length; ++l) {
				...
				if (s.marker.collapsed) {
					...
					if (
						!((0 <= u && c <= 0) || (u <= 0 && 0 <= c)) &&
						((u <= 0 &&
							(s.marker.inclusiveRight && i.inclusiveLeft ? 0 <= P(a.to, n) : 0 < P(a.to, n))) ||
							(0 <= u &&
	...
	function hn(e, t) {
		...
		for (var i = 0; i <= (t.rest ? t.rest.length : 0); i++) {
			...
			(!(function (e, t, n) {
				...
				if (r)
					for (var l, s, a, u, c, h, d, f = i.length, p = 0, g = 1, m = '', v = 0; ; ) {
						if (v == p) {
							...
							if (h && (h.from || 0) == p) {
								if (
									(pn(t, (null == h.to ? f + 1 : h.to) - p, h.marker, null == h.from), null == h.to)
								)
									return;
								h.to == p && (h = !1);
							}
				...
				o.styleClasses &&
					(o.styleClasses.bgClass && (r.bgClass = oe(o.styleClasses.bgClass, r.bgClass || '')),
						...
						r.content.appendChild(
							...
							null == Qe &&
								...
								0 != l.firstChild.offsetHeight &&
									(Qe = o.offsetWidth <= 1 && 2 < o.offsetHeight && !(w && v < 8))),
							(l = Qe
								? M('span', '​')
								: M(
										'span',
		...
		return (
			x &&
				...
				(/\bcm-tab\b/.test(n.className) || (n.querySelector && n.querySelector('.cm-tab'))) &&
				...
				for (var c = document.createDocumentFragment(), h = 0; ; ) {
					...
					('\t' == d[0]
						...
						: ('\r' == d[0] || '\n' == d[0]
								...
								: ((p = e.cm.options.specialCharPlaceholder(d[0])).setAttribute('cm-text', d[0]),
									w && v < 9 ? c.appendChild(M('span', [p])) : c.appendChild(p)),
							(e.col += 1)),
	...
	function pn(e, t, n, r) {
		...
		(i && e.map.push(e.pos, e.pos + t, i),
			!r &&
				...
				(i = i || e.content.appendChild(document.createElement('span'))).setAttribute(
					'cm-marker',
					n.id,
				),
		...
		if (n.length)
			for (
				var r,
					...
					o =
						(vn ? (r = vn.delayedCallbacks) : yn ? (r = yn) : ((r = yn = []), setTimeout(bn, 0)),
						0);
				o < n.length;
				++o
			)
	...
	function wn(e, t, n, r) {
		for (var i = 0; i < t.changes.length; i++) {
			...
			if ('text' == o) {
				...
				for (var h = J('CodeMirror-linewidget'), d = c.node.firstChild, f = void 0; d; d = f)
	...
	function Sn(e, t) {
		((e = e),
			(i = (n = t).bgClass ? n.bgClass + ' ' + (n.line.bgClass || '') : n.line.bgClass) &&
					...
					u &&
						l.appendChild(
							M(
								...
								'left: ' + r.gutterLeft[a] + 'px; width: ' + r.gutterWidth[a] + 'px',
							),
						);
				}
		}
		...
		if (t.widgets)
			for (var o = xn(n), l = 0, s = t.widgets; l < s.length; ++l) {
				...
				(c.noHScroll &&
					...
					c.coverGutter ||
						((d -= f.gutterTotalWidth), (h.style.paddingLeft = f.gutterTotalWidth + 'px')),
					(h.style.width = d + 'px')),
					c.coverGutter &&
						((h.style.zIndex = 5),
		...
		if (t.cache.hasOwnProperty(l)) o = t.cache[l];
			...
			(o = (function (e, t, n, r) {
				...
				!(w && v < 9) ||
					...
					(i = n
						? { left: n.left, right: n.left + ar(e.display), top: n.top, bottom: n.bottom }
						: Gn));
				for (
	...
	function _n(e, t, n, r, i) {
		...
		return (
			...
			('page' != r && 'window' != r) ||
				((i +=
					(t = e.display.lineSpace.getBoundingClientRect()).top + ('window' == r ? 0 : Yn(ae(e)))),
	...
	function Jn(e, t) {
		var n = 0,
			t =
				((t = E(e.doc, t)), e.options.lineWrapping || (n = ar(e.display) * t.ch), W(e.doc, t.line)),
			e = rn(t) + On(e.display);
			...
			var s = (function (n, e, t, r, i) {
						...
						c = De(
							function (e) {
								...
								return (
									(t.top += l),
									(t.bottom += l),
									ir(t, r, i, !1) && (t.top <= i && t.left <= r && ((h = e), (d = t)), 1)
								);
							},
							s,
							a,
						...
						f = !1;
					{
						...
						d
							...
							: (u || (c != a && c != s) || c++,
								(g =
									0 == c || (c != e.text.length && Rn(n, o, c - (u ? 1 : 0)).bottom + l <= i == u)
										? 'after'
										: 'before'),
	...
	function or(n, r, i, o, l, s, a) {
		...
		return (
			0 < t &&
				((e = 1 != u.level),
				ir((e = Qn(n, F(i, e ? u.from : u.to, e ? 'after' : 'before'), 'line', r, o)), s, a, !0) &&
					e.top > a &&
					(u = l[t - 1])),
			u
		);
	...
	function lr(e, t, n, r, i, o, l) {
		for (
			...
			f.from >= a ||
				f.to <= s ||
				((d =
					(d = Rn(e, r, 1 != f.level ? Math.min(a, f.to) - 1 : Math.max(s, f.from)).right) < o
						? o - d + 1e9
						: d - o),
				(!u || d < c) && ((u = f), (c = d)));
		}
		return (u =
			(u = (u = u || i[i.length - 1]).from < s ? { from: s, to: u.to, level: u.level } : u).to > a
	...
	function fr(e, t, n, r) {
		...
		return (
			r &&
				...
				(i = F(i.line, Math.max(0, Math.round((o - Dn(e.display).left) / ar(e.display)) - n)))),
			i
		);
	}
	function pr(e, t) {
					...
					(function (i, e, t) {
						...
						function s(n, g, m) {
							...
							function x(e, t, n) {
								...
								return w(
									'after' == n ? e.begin : e.end - (/\s/.test(r.text.charAt(e.end - 1)) ? 2 : 1),
									t,
								)[t];
							}
						...
						((n = e.from()), (r = e.to()));
						{
							...
							n.line == r.line
								...
								: ((e = W(o, n.line)),
									...
									a &&
										(n.top < e.top - 2
											? (T(n.right, n.top, null, n.bottom), T(S, e.top, e.left, e.bottom))
	...
	function Mr(e, t) {
		e.state.delayingBlurEvent ||
			(e.state.focused &&
				(O(e, 'blur', e, t), (e.state.focused = !1), ee(e.display.wrapper, 'CodeMirror-focused')),
	...
	function Nr(e) {
		for (
			...
			if (!s.hidden) {
				...
				var h,
					a = s.line.height - u;
				if ((0.005 < a || a < -0.005) && (i < r && (o -= a), mt(s.line, u), Or(s.line), s.rest))
	...
	function Dr(e, t) {
		var n = e.display,
			...
			i =
				(t.top < 0 && (t.top = 0),
				(e.curOp && null != e.curOp.scrollTop ? e.curOp : n.scroller).scrollTop),
			o = Fn(e),
			l = {},
	...
	function Wr(e, t) {
		null != t &&
			(Pr(e), (e.curOp.scrollTop = (null == e.curOp.scrollTop ? e.doc : e.curOp).scrollTop + t));
	}
	function Hr(e) {
		Pr(e);
		var t = e.getCursor();
			...
			((n.style.visibility = ''),
				r.set(1e3, function e() {
					...
					('vert' == i
						...
						: document.elementFromPoint((t.right + t.left) / 2, t.bottom - 1)) != n
	...
	function Xr(n) {
		(n.display.scrollbars &&
			...
			n.display.scrollbars.addClass && ee(n.display.wrapper, n.display.scrollbars.addClass)),
				...
				for (var n = e.ops, r = 0; r < n.length; r++) {
					...
					((function (e) {
						...
						(i.mustUpdate =
							...
							null != i.scrollTop ||
							(i.scrollToPos &&
								(i.scrollToPos.from.line < l.viewFrom || i.scrollToPos.to.line >= l.viewTo)) ||
					...
					((c.barMeasure = Br(h)),
						d.maxLineChanged &&
							...
							(c.barMeasure.scrollWidth = Math.max(
								...
								d.sizer.offsetLeft + c.adjustWidthTo + Wn(h) + h.display.barWidth,
							)),
				...
				for (var f = 0; f < n.length; f++) {
					...
					null != p.adjustWidthTo &&
						...
						p.maxScrollLeft < g.doc.scrollLeft &&
							Rr(g, Math.min(g.display.scroller.scrollLeft, p.maxScrollLeft), !0),
						...
						((v = (function (e, t, n, r) {
							(null == r && (r = 0),
								e.options.lineWrapping ||
									t != n ||
									((n = 'before' == t.sticky ? F(t.line, t.ch + 1, 'before') : t),
									(t = t.ch ? F(t.line, 'before' == t.sticky ? t.ch - 1 : t.ch, 'after') : t)));
							for (var i = 0; i < 5; i++) {
								var o,
									l = !1,
									s = Qn(e, t),
								...
								if (
									(null != s.scrollTop &&
										(Ir(e, s.scrollTop), 1 < Math.abs(e.doc.scrollTop - a) && (l = !0)),
									null != s.scrollLeft &&
										(Rr(e, s.scrollLeft), 1 < Math.abs(e.doc.scrollLeft - u) && (l = !0)),
									!l)
								)
									break;
							}
						...
						(function (e, t) {
							...
							A(e, 'scrollCursorIntoView') ||
								...
								t.top + o.top < 0
									? (r = !0)
									: t.bottom + o.top >
											(i.defaultView.innerHeight || i.documentElement.clientHeight) && (r = !1),
								null == r ||
									X ||
									((o = M(
										'div',
						...
						var t = e.styles,
							...
							i =
								...
								!t ||
									...
									(n != r && (!n || !r || n.bgClass != r.bgClass || n.textClass != r.textClass))),
							o = 0;
						!i && o < t.length;
						++o
					)
			...
			if (!y.hidden)
				if (y.node && y.node.parentNode == d) {
					...
					(y.changes && (-1 < L(y.changes, 'gutter') && (b = !1), wn(s, y, m, u)),
						b &&
							(te(y.lineNumber),
							y.lineNumber.appendChild(document.createTextNode(bt(s.options, m)))),
			...
			return (
				...
				t.length != n.lineNumChars
					? ((r = (i = n.measure.appendChild(
							M('div', [M('div', t)], 'CodeMirror-linenumber CodeMirror-gutter-elt'),
	...
	function pi(e, t) {
		...
		if ((r && s) || (n && a)) {
			...
			(n &&
				...
				(i = n * i) < 0 ? (s = Math.max(0, s + i - 50)) : (a = Math.min(e.doc.height, a + i + 50)),
				ti(e, { top: s, bottom: a })),
				ci < 20 &&
					0 !== t.deltaMode &&
					(null == o.wheelStartX
						? ((o.wheelStartX = l.scrollLeft),
							...
							setTimeout(function () {
								...
								null != o.wheelStartX &&
									...
									(t =
										((t = l.scrollTop - o.wheelStartY) && o.wheelDY && t / o.wheelDY) ||
	...
	function vi(e) {
		return e.text
			? F(e.from.line + e.text.length - 1, z(e.text).length + (1 == e.text.length ? e.from.ch : 0))
			: e.to;
	}
	function yi(e, t) {
		...
		if (
			(l.lastOp == r ||
				(l.lastOrigin == t.origin &&
					t.origin &&
					(('+' == t.origin.charAt(0) &&
						l.lastModTime > s - (e.cm ? e.cm.options.historyEventDelay : 500)) ||
						'*' == t.origin.charAt(0)))) &&
			(o =
				(o = l).lastOp == r
					? (Ai(o.done), z(o.done))
			...
			((i = z(o.changes)),
				0 == P(t.from, t.to) && 0 == P(t.from, i.to) ? (i.to = vi(t)) : o.changes.push(Oi(e, t)));
		else {
			var a = z(l.done);
			for (
	...
	function zi(e, t, n, r) {
		return r
			? ((r = e.anchor),
				n && ((e = P(t, r) < 0) != P(n, r) < 0 ? ((r = t), (t = n)) : e != P(t, n) < 0 && (t = n)),
				new G(r, t))
			: new G(n || t, t);
	}
	...
	function Ki(e, t, n) {
		...
		(ji(e, Yi(e, t, o, !0)),
			(n && !1 === n.scroll) || !e.cm || 'nocursor' == e.cm.getOption('readOnly') || Hr(e.cm));
	}
	function ji(e, t) {
		t.equals(e.sel) ||
			((e.sel = t),
					...
					if (a.atomic) {
						if (n) {
							var s = a.find(r < 0 ? 1 : -1),
								h = void 0;
							if (
								(s = (r < 0 ? c : u) ? qi(e, s, -r, s && s.line == t.line ? o : null) : s) &&
								s.line == t.line &&
								(h = P(s, n)) &&
								(r < 0 ? h < 0 : 0 < h)
							)
						...
						h = a.find(r < 0 ? -1 : 1);
						return (h = (r < 0 ? u : c) ? qi(e, h, r, h.line == t.line ? o : null) : h)
							? $i(e, h, t, r, i)
							: null;
					}
				}
		...
		if (!(je(e, 'beforeChange') || (e.cm && je(e.cm, 'beforeChange'))) || (t = Qi(e, t, !0))) {
			...
			if (r)
				for (var i = r.length - 1; 0 <= i; --i)
					eo(e, { from: r[i].from, to: r[i].to, text: i ? [''] : t.text, origin: t.origin });
			else eo(e, t);
		}
	}
	function eo(e, n) {
	...
	function ro(e, t, n, r) {
		...
		if (t.to.line < e.first) no(e, t.text.length - 1 - (t.to.line - t.from.line));
			...
			if (
				(((t =
					t.to.line > i
						? { from: t.from, to: F(i, W(e, i).text.length), text: [t.text[0]], origin: t.origin }
					...
					f =
						...
						i.options.lineWrapping ||
							(s.iter(d, u.line + o.text.length, function (e) {
								var t = on(e);
								t > a.maxLineLength &&
									((a.maxLine = e), (a.maxLineLength = t), (a.maxLineChanged = !0), (h = !1));
							}),
				...
				(qr(i, 400),
					...
					(d = je(i, 'changes')),
					((s = je(i, 'change')) || d) &&
						((l = { from: u, to: c, text: o.text, removed: o.removed, origin: o.origin }),
						s && b(i, 'change', i, l),
		...
		for (var i = 0; i < e.length; ++i) {
			...
			if (o.ranges) {
				...
				for (var a = 0; a < o.changes.length; ++a) {
					var u = o.changes[a];
					if (n < u.from.line)
						((u.from = F(u.from.line + r, u.from.ch)), (u.to = F(u.to.line + r, u.to.ch)));
					else if (t <= u.to.line) {
						l = !1;
						break;
					}
	...
	function mo(r, i, o, e, t) {
		...
		if (
			...
			if (Qt(r, i.line, i, o, d) || (i.line != o.line && Qt(r, o.line, i, o, d)))
		...
		if (
			...
			d.readOnly &&
				((zt = !0), (r.history.done.length || r.history.undone.length) && r.clearHistory()),
	...
	((po.prototype.clear = function () {
		if (!this.explicitlyCleared) {
			for (
				var e,
					...
					r =
						(n && $r(t),
						!je(this, 'clear') || ((e = this.find()) && b(this, 'clear', e.from, e.to)),
						null),
					i = null,
					o = 0;
				o < this.lines.length;
			...
			r &&
				...
				h(o, function () {
					...
					(t && (Vn(t), (o.curOp.selectionChanged = o.curOp.forceUpdate = !0)),
						...
						nn(i.doc, e) ||
							null == i.height ||
							((t = i.height), (i.height = null), (t = Mn(i) - t) && mt(e, e.height + t)),
		...
		(po.prototype.detachLine = function (e) {
			(this.lines.splice(L(this.lines, e), 1),
				!this.lines.length &&
					this.doc.cm &&
					((e = this.doc.cm.curOp).maybeHiddenMarkers || (e.maybeHiddenMarkers = [])).push(this));
		}),
		Xe(po));
	var vo = function (e, t) {
		...
		xo =
			(((f.prototype = Se(co.prototype, {
				...
				setSelections: n(function (e, t, n) {
					if (e.length) {
						for (var r = [], i = 0; i < e.length; i++)
							r[i] = new G(E(this, e[i].anchor), E(this, e[i].head || e[i].anchor));
					...
					return ao(this, e, 'gutter' == o ? 'gutter' : 'class', function (e) {
						...
						if (n) {
							if (null == l) e[t] = null;
								...
								e[t] =
									n.slice(0, r.index) + (r.index && i != n.length ? ' ' : '') + n.slice(i) || null;
							}
							return 1;
						}
					});
				...
				linkedDoc: function (e) {
					for (
						...
						var l = i[o],
							...
							s = r.clipPos(s.to);
						P(a, s) &&
							((a = mo(r, a, s, l.primary, l.primary.type)), l.markers.push(a), (a.parent = l));
					}
					return n;
				},
			...
			if (t && !r.isReadOnly())
				if (n && n.length && window.FileReader && window.File)
					...
					try {
						...
						if (c) {
							if (
								(r.state.draggingText && !r.state.draggingText.copy && (u = r.listSelections()),
								Ki(r.doc, mi(t, t)),
								u)
							)
	...
	function Ko(t, n, s, e) {
		...
		return null == d || (0 < e && d == n.text.length) || !(i = f(0 < e ? 0 : a.length - 1, e, o(d)))
			? null
			: i;
	}
	((Wo.basic = {
						...
						(t = W(l.doc, e.line).text) &&
							(0 < (e = e.ch == t.length ? new F(e.line, e.ch - 1) : e).ch
								...
								: e.line > l.doc.first &&
									...
									((e = new F(e.line, 1)),
									l.replaceRange(
										t.charAt(0) + l.doc.lineSeparator() + n.charAt(n.length - 1),
	...
	function Zo(e, t, n, r) {
		r = (function (e, t, n) {
			...
			return (
				(e.options.extraKeys && Po(t, e.options.extraKeys, n, e)) || Po(t, e.options.keyMap, n, e)
			);
		})(e, t, r);
		return (
	...
	function el(e) {
		...
		function o(e) {
			(18 != e.keyCode && e.altKey) ||
				(ee(r, 'CodeMirror-crosshair'), T(document, 'keyup', o), T(document, 'mouseover', o));
		}
				...
				: ul(c, e) ||
					...
					(t &&
						(function (n, e, r, t, i) {
							...
							return qo(
								n,
								Io((o = (1 == e ? 'Left' : 2 == e ? 'Middle' : 'Right') + o), i),
								i,
								function (e) {
									...
									(i.options.dragDrop &&
												...
												var o = t.display,
													...
													s = R(t, function (e) {
														(x && (o.scroller.draggable = !1),
															...
															l ||
																...
																(x && !j) || (w && 9 == v)
																	? setTimeout(function () {
																			(o.wrapper.ownerDocument.body.focus({ preventScroll: !0 }),
																				o.input.focus());
																		}, 20)
																	: o.input.focus()));
													}),
													a = function (e) {
														l =
															l ||
															10 <=
																Math.abs(n.clientX - e.clientX) + Math.abs(n.clientY - e.clientY);
													},
													u = function () {
														return (l = !0);
													};
										...
										: function (d, e, f, p) {
												...
												var m,
													...
													t = y.ranges;
												p.addNew && !p.extend
													? ((v = g.sel.contains(f)), (m = -1 < v ? t[v] : new G(f, f)))
													: ((m = g.sel.primary()), (v = g.sel.primIndex));
												'rectangle' == p.unit
													? (p.addNew || (m = new G(f, f)), (f = fr(d, e, !0, !0)), (v = -1))
													: ((e = sl(d, f, p.unit)),
														(m = p.extend ? zi(m, e.anchor, e.head, p.extend) : e));
												p.addNew
													? -1 == v
														? ((v = t.length),
															U(g, gi(d, t.concat([m]), v), { scroll: !1, origin: '*mouse' }))
														: 1 < t.length && t[v].empty() && 'char' == p.unit && !p.extend
															? (U(g, gi(d, t.slice(0, v).concat(t.slice(v + 1)), 0), {
																	scroll: !1,
																	origin: '*mouse',
																}),
																(y = g.sel))
														...
														if (((b = e), 'rectangle' == p.unit)) {
															for (
																...
																o == l
																	...
																	: u.length > c && t.push(new G(F(s, c), F(s, ye(u, l, n))));
															}
	...
	function al(e, t, n, r) {
		...
		for (var s = 0; s < e.display.gutterSpecs.length; ++s) {
			...
			if (a && a.getBoundingClientRect().right >= i)
				return (O(e, n, e, vt(e.doc, o), e.display.gutterSpecs[s].className, t), $e(t));
		}
	}
	function ul(e, t) {
	...
	function cl(e, t) {
		var n, r;
		Nn(e.display, t) ||
			((r = t), je((n = e), 'gutterContextMenu') && al(n, r, 'gutterContextMenu', !1)) ||
			A(e, t, 'contextmenu') ||
			Q ||
	...
	function p(e, t) {
		...
		(k(s.scroller, 'touchstart', function (e) {
			...
			A(l, e) ||
				...
				1 == e.touches.length &&
					((s.activeTouch.left = e.touches[0].pageX), (s.activeTouch.top = e.touches[0].pageY)));
		}),
			...
			k(s.scroller, 'scroll', function () {
				s.scroller.clientHeight &&
					(Ir(l, s.scroller.scrollTop), Rr(l, s.scroller.scrollLeft, !0), O(l, 'scroll', l));
			}),
						...
						w && (!t.state.draggingText || +new Date() - xo < 100)
							...
							: A(t, e) ||
								...
								e.dataTransfer.setDragImage &&
									!j &&
									(((n = M('img', null, null, 'position: fixed; left: 0; top: 0;')).src =
	...
	function yl(e, t, n, r) {
		...
		if (r || /\S/.test(s.text)) {
			if (
				'smart' == n &&
				((c = o.mode.indent(i, s.text.slice(u.length), s.text)) == pe || 150 < c)
			) {
				if (!r) return;
				n = 'prev';
			}
			...
			for (var n = e.doc.sel, r = n.ranges.length - 1; 0 <= r; r--) {
				...
				if (!(100 < i.head.ch || (r && n.ranges[r - 1].head.line == i.head.line))) {
					...
					if (o.electricChars) {
						...
						o.electricInput &&
							o.electricInput.test(W(e.doc, i.head.line).text.slice(0, i.head.ch)) &&
							(l = yl(e, i.head.line, 'smart'));
	...
	function Ml(n, r, i, o, l) {
				...
				(t =
					'codepoint' == o
						? ((t = s.text.charCodeAt(r.ch + (0 < i ? 0 : -1))),
							isNaN(t)
								? null
								: ((t = 0 < i ? 55296 <= t && t < 56320 : 56320 <= t && t < 57343),
									new F(r.line, Math.max(0, Math.min(s.text.length, r.ch + i * (t ? 2 : 1))), -i)))
						: l
							? Ko(n.cm, s, r, i)
							: Uo(s, r, i))
			) {
		...
		if ('char' == o || 'codepoint' == o) u();
			...
			for (
				var c = null, h = 'group' == o, d = n.cm && n.cm.getHelper(r, 'wordChars'), f = !0;
				!(i < 0) || u(!f);
				f = !1
			) {
	...
	((r.prototype.init = function (e) {
			...
			if (
				...
				if (!i || i.bad || !o || o.bad || 0 != P(St(i, o), r) || 0 != P(Ct(i, o), n)) {
					...
					if (
						(r ||
							(r = {
								node: (i = (n = i[i.length - 1].measure).maps ? n.maps[n.maps.length - 1] : n.map)[
									i.length - 1
								],
		...
		(r.prototype.pollContent = function () {
			...
			var o,
				...
				n =
					r == n.view.length - 1
						...
						: ((o = H(n.view[r + 1].line) - 1), n.view[r + 1].node.previousSibling);
			if (!l) return !1;
			for (
			...
			for (
				var p = z(s),
					g = z(a),
					m = Math.min(p.length - (1 == s.length ? u : 0), g.length - (1 == a.length ? u : 0));
	...
	((i.prototype.init = function (n) {
		...
		(i.prototype.poll = function () {
			...
			if ((w && 9 <= v && this.hasSelection === i) || (C && /[\uf700-\uf7ff]/.test(i)))
		...
		(Fl.prototype = {
					...
					i =
						'number' == typeof e
							? ((i = this.doc.first + this.doc.size - 1),
								e < this.doc.first ? (e = this.doc.first) : i < e && ((e = i), (r = !0)),
								W(this.doc, e))
							: e;
				return (
				...
				((t.style.position = 'absolute'),
					...
					'over' == r
						...
						: ('above' != r && 'near' != r) ||
							...
							('above' == r || e.bottom + t.offsetHeight > l) && e.top > t.offsetHeight
					...
					'right' == i
						...
						: ('left' == i
								? (u = 0)
								: 'middle' == i && (u = (s.sizer.clientWidth - t.offsetWidth) / 2),
							(t.style.left = u + 'px')),
					n &&
						((r = this),
			...
			findPosV: function (e, t, n, r) {
				for (
					var i = 1, o = r, l = (t < 0 && ((i = -1), (t = -t)), E(this.doc, e)), s = 0;
					s < t;
					++s
				) {
					var a = Qn(this, l, 'div');
			...
			refresh: t(function () {
				...
				(I(this),
					...
					ni(this.display),
					(null == e || 0.5 < Math.abs(e - sr(this.display)) || this.options.lineWrapping) &&
						dr(this),
					O(this, 'refresh', this));
			}),
