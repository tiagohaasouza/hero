!(function (e) {
	...
	function o(t, e) {
		for (var n = [], i = 0; i < e.length; i++) {
			...
			('object' == typeof r && r.nonEmpty ? o.anchor.line == o.head.line : o.empty()) &&
				((r = t.getLineHandleVisualStart(o.head.line)), n[n.length - 1] != r && n.push(r));
		}
		!(function (e, t) {
	...
	i.defineOption('styleActiveLine', !1, function (e, t, n) {
		n = n != i.Init && n;
		t != n &&
			(n && (e.off('beforeSelectionChange', r), l(e), delete e.state.activeLines),
			t &&
				((e.state.activeLines = []), o(e, e.listSelections()), e.on('beforeSelectionChange', r)));
	});
});
