		...
		var _ = {
			...
			restricted_atBlock: function (e, t, r) {
				return '}' == e
					...
					: 'word' == e
						? ((i =
								('@font-face' == r.stateArg && !m.hasOwnProperty(t.current().toLowerCase())) ||
								('@counter-style' == r.stateArg && !g.hasOwnProperty(t.current().toLowerCase()))
									? 'error'
									: 'property'),
							'maybeprop')
						: 'restricted_atBlock';
				...
				return (
					(e = 'prop' != e.type || ('}' != t && ')' != t) ? e : e.prev).prev &&
						...
						('block' != e.type &&
							...
							? ((')' != t || ('parens' != e.type && 'atBlock_parens' != e.type)) &&
