!(function (e) {
	...
	var n = { pairs: '()[]{}\'\'""', closeBefore: ')]}\'":;>', triples: '', explode: '[]{}' },
		k = S.Pos;
	function y(e, t) {
					...
					return function (e) {
						...
						for (
							...
							if (h && !d.empty()) u = 'surround';
								...
								if (
									...
									if (2 < p.ch && /\bstring/.test(i.getTokenTypeAt(k(p.line, p.ch - 2))))
										return S.Pass;
									u = 'addFour';
								} else if (l) {
								...
								u =
									...
									(function (e, t) {
										...
										? 'both'
										: 0 <= s.indexOf(t) && i.getRange(p, k(p.line, p.ch + 3)) == t + t + t
											? 'skipThree'
											: 'skip';
							if (a) {
						...
						i.operation(function () {
							if ('skip' == a) m(i, 1);
								...
								'both' == a
									? (i.replaceSelection(v + b, null), i.triggerElectric(v + b), m(i, -1))
									: 'addFour' == a && (i.replaceSelection(v + v + v + v, 'before'), m(i, 1));
							var n, r;
						});
					};
				})(n));
