!(function (e) {
	...
	((e.commands.toggleComment = function (e) {
		...
		e.defineExtension('toggleComment', function (e) {
			e = e || L;
			for (
				var n = this, t = 1 / 0, i = this.listSelections(), l = null, o = i.length - 1;
				0 <= o;
				o--
			) {
				var r = i[o].from(),
				...
				r.line >= t ||
					...
					(t = r.line),
					null == l
						? (l = n.uncomment(r, m, e) ? 'un' : (n.lineComment(r, m, e), 'line'))
						: 'un' == l
							? n.uncomment(r, m, e)
							: n.lineComment(r, m, e));
			}
		...
		e.defineExtension('lineComment', function (o, e, r) {
			...
			var m,
				...
				t = s.getLine(o.line);
			null != t &&
				((t = t), !/\bstring\b/.test(s.getTokenTypeAt(R(o.line, 0))) || /^[\'\"\`]/.test(t)) &&
				((m = r.lineComment || n.lineComment)
					? ((a = Math.min(0 != e.ch || e.line == o.line ? e.line + 1 : e.line, s.lastLine() + 1)),
						(c = null == r.padding ? ' ' : r.padding),
						(g = r.commentBlankLines || o.line == e.line),
						s.operation(function () {
							if (r.indent) {
								for (var e = null, n = o.line; n < a; ++n) {
									var t = -1 === (i = s.getLine(n)).search(x) ? i : i.slice(0, f(i));
								...
								for (n = o.line; n < a; ++n) {
									var i = s.getLine(n),
										l = e.length;
									(g || x.test(i)) &&
										(i.slice(0, l) != e && (l = f(i)), s.replaceRange(e + m + c, R(n, 0), R(n, l)));
								}
							} else
								for (n = o.line; n < a; ++n)
		...
		e.defineExtension('blockComment', function (o, r, m) {
			...
			f && d
							...
							if (0 != m.fullLines) {
								var e = x.test(g.getLine(a)),
									n =
										...
										m.blockCommentLead || s.blockCommentLead);
								if (null != n)
				...
				: (m.lineComment || s.lineComment) && 0 != m.fullLines && g.lineComment(o, r, m);
		}),
		e.defineExtension('uncomment', function (e, n, t) {
			...
			var l,
				o = this,
				i = O(o, e),
				r = Math.min(0 != n.ch || n.line == e.line ? n.line : n.line - 1, o.lastLine()),
				m = Math.min(e.line, r),
			...
			e: if (a) {
				for (var s = m; s <= r; ++s) {
					var f = o.getLine(s),
						d = f.indexOf(a);
					if (
						-1 == (d = -1 < d && !/comment/.test(o.getTokenTypeAt(R(s, d + 1))) ? -1 : d) &&
						x.test(f)
					)
						break e;
			...
			if (
				...
				return !1;
			i = -1 == (t = p.lastIndexOf(u, e.ch)) ? -1 : p.slice(0, e.ch).indexOf(h, t + u.length);
