!(function (e) {
	...
	(rt.defineMode('javascript', function (e, l) {
		...
		function d(e, t) {
			...
			if (/\d/.test(r))
				return (e.match(/^[\d_]*(?:n|(?:\.[\d_]*)?(?:[eE][+\-]?[\d_]+)?)?/), i('number', 'number'));
			if ('/' == r)
				return e.eat('*')
					? (t.tokenize = K)(e, t)
					: e.eat('/')
		...
		function Q(e, t) {
			...
			if (!(r < 0)) {
				!u ||
					((n = /:\s*(?:\w+(?:<[^>]*>|\[\])?|\{[^}]*\})\s*$/.exec(e.string.slice(e.start, r))) &&
						(r = n.index));
		...
		function ee(e) {
			return (
				'public' == e || 'private' == e || 'protected' == e || 'abstract' == e || 'readonly' == e
			);
		}
		function te(e, t, r) {
		...
		return (
			...
			(y.lex = k.lex = !0),
			{
				startState: function (e) {
					...
					return (
						l.globalVars && 'object' == typeof l.globalVars && (e.globalVars = l.globalVars),
						e
					);
				},
				token: function (e, t) {
					...
					return 'comment' == H
						? r
						: ((t.lastType = 'operator' != H || ('++' != D && '--' != D) ? H : 'incdec'),
							Y(t, r, H, D, e));
				},
				indent: function (e, t) {
					...
					for (
						...
						('}' == n ||
							((r = e.cc[e.cc.length - 1]) && (r == j || r == M) && !/^[,\.=+\-*:?[\(]/.test(t)));

					)
						a = a.prev;
					var c,
						s = (a = N && ')' == a.type && 'stat' == a.prev.type ? a.prev : a).type,
						u = n == s;
					return 'vardef' == s
		...
		rt.defineMIME('application/manifest+json', { name: 'javascript', json: !0 }),
		rt.defineMIME('application/ld+json', { name: 'javascript', jsonld: !0 }),
		rt.defineMIME('text/typescript', { name: 'javascript', typescript: !0 }),
		rt.defineMIME('application/typescript', { name: 'javascript', typescript: !0 }));
});
